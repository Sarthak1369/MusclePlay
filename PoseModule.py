...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            print(lmList[14]) #this number shows that which point we are tracking
            cv2.circle(img, (lmList[14][1], lmList[14][2]), 15, (0,0,255), cv2.FILLED) #it cirls that point we are tracking
